...
const spid_controller = require('../../controllers/saml2/spid');
...
if (config.eidas.enabled) {
    router.get(
        ...
        web_check_perm_controller.owned_permissions,
        csrf_protection,
        saml2_controller.step_new_eidas_credentials
    );
    router.post(
        '/:application_id/step/eidas',
        web_check_perm_controller.owned_permissions,
        csrf_protection,
        saml2_controller.step_create_eidas_credentials
    );
    router.put(
...
} else if (config.spid.enabled) {
    router.get(
        '/:application_id/step/spid',
        web_check_perm_controller.owned_permissions,
        csrf_protection,
        spid_controller.step_new_spid_credentials
    );
    router.post(
        '/:application_id/step/spid',
        web_check_perm_controller.owned_permissions,
        csrf_protection,
        spid_controller.step_create_spid_credentials
    );
    router.put(
        '/:application_id/edit/spid/info',
        web_check_perm_controller.owned_permissions,
        csrf_protection,
        saml2_controller.search_saml_credentials,
        spid_controller.update_spid_info
    );
    router.put(
        '/:application_id/edit/spid/attributes',
        web_check_perm_controller.owned_permissions,
        csrf_protection,
        spid_controller.update_spid_attributes
    );
    router.get(
        '/:application_id/edit/spid',
        web_check_perm_controller.owned_permissions,
        csrf_protection,
        saml2_controller.search_saml_credentials,
        spid_controller.edit_spid_credentials
    );
    router.get(
        '/:application_id/saml2/metadata',
        saml2_controller.search_saml_credentials,
